...
var defaultTemplateMap = exports.defaultTemplateMap = Object.freeze({
...
var defaultBookOptionsMap = exports.defaultBookOptionsMap = Object.freeze({
...
var defaultKeyValueMap = exports.defaultKeyValueMap = Object.freeze({
    // Local
    class: "",
    id: "",
    marker: "",
...
function checkMapTypes(kvMap, funcLabel) {
    Object.keys(kvMap).forEach(function (key) {
        if (defaultKeyValueMap[key] != undefined) {
            if (!(_typeof(kvMap[key]) === _typeof(defaultKeyValueMap[key]))) {
                logger.error("include-codeblock: checkMapTypes (" + funcLabel + ") : wrong value type for key `" + key + "`: " + "key type: `" + _typeof(kvMap[key]) + "` (!= `" + _typeof(defaultKeyValueMap[key]) + "`)");
            }
        }
    });
}
...
function initOptions(options) {
    ...
    var kv = Object.assign({}, defaultKeyValueMap);
